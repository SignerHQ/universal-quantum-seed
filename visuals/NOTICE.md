...
SVG blob in that pinned upstream tree. For reproducible inventory review, sort
the files numerically and hash the following byte sequence for each file:
UTF-8 `directory/name`, a NUL byte, the file bytes, and another NUL byte.
